            ...
            <div>
                <center>
                  ...
                  <Paper style={{padding:50}}>
                    <p>The railroad has been extended north to St. Albans, VT and south to Roanoke, VA by adding 21 more stations to the existing 24 stations. More trains have been added to accommodate the stations. There are total 28 trains, of which 14 travel in either direction. Each train has days when it runs, an origin and a destination station. To reserve a trip for, the train has to be running on the date, traversing the segments of the trip and has free seat. The availability of the seat is calculated by checking if there are seats available for each of the segment of the trip for the given train and date. The fare of the reservation of the trip is calculated by adding the fare associated with each segment.</p>
                  </Paper>
